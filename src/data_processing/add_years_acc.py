# %%
"""
Add model accuracy scores to dates_years dataset
"""
import json
...
# %%
general_data_path = repo_root() / "data" / "dates_years"

# List of files to process (T.jsonl, V.jsonl)
files_to_process = [
